...
- [Semantic Analysis](architecture/semantics.md)
- [Lowering](architecture/lowering.md)
- [Assembler and Metadata](architecture/assembler-and-metadata.md)
- [Class-File Backend](architecture/classfile.md)
...
- [Maintainer Workflow](contributing/workflow.md)
...
- [Class-File Impact](research/classfile-impact.md)
- [Values and Expressions](research/values-and-expressions.md)
- [Control Flow](research/control-flow.md)
- [Declarations and Types](research/declarations-and-types.md)
- [Compilation Units](research/compilation-units.md)
- [Modern Java](research/modern-java.md)

# Direction

- [Architecture Direction](direction/architecture.md)
- [Language Rungs](direction/language-rungs.md)
- [Active Work](direction/active-work.md)
