...
/// Greedy reduction to a fixpoint (or the spawn cap). Candidate order is
/// load-bearing for stable minimized artifacts.
pub(super) fn minimize(prog: &Prog, h: &mut MinHarness) -> Prog {
